    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AllowedUsers", x => x.AllowedUserId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TagEntityTagName = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuizTags", x => new { x.QuizId, x.Tag });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_QuizTags_Tags_TagEntityTagName",
                        column: x => x.TagEntityTagName,
                        principalTable: "Tags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizTags_TagEntityTagName",
                table: "QuizTags",
                column: "TagEntityTagName");
